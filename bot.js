...
client.user.setGame(`Wolves Games`,"http://twitch.tv/S-F")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
...
client.on('message', message => {
    ...
    if (message.content == 'نقاطي'){
        ...
        .setColor('RANDOM')
        .setFooter('Wolves games', client.user.avatarURL);
        message.channel.sendEmbed(embed)
    };
    if (message.content == "فكك") {    
        var x = ['ضفدع', 'طيارة', 'رعودي', 'تفكيك', 'تجربة', 'مدرسة', 'معلم' , 'نقاط' , 'اكسيفو' , 'فهد' , 'هكونا مطاطا' , 'اكسيفو ذا بيست'];
